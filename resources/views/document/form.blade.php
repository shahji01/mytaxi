                    ...
                    <div class="card-body">
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('group_document_field_id', __('Group'), ['class' => 'form-control-label']) }}
                                    {{ Form::select('group_document_field_id', $groups->pluck('name', 'id')->toArray(), old('group_document_field_id'), ['class' => 'form-control select2js', 'required']) }}
                                </div>
                                <div class="form-group col-md-4">
                                    {{ Form::label('document_field_id', __('Fields'), ['class' => 'form-control-label']) }}
                                    {{ Form::select('document_field_id', $fields->pluck('name', 'id')->toArray(), old('document_field_id'), ['class' => 'form-control select2js', 'required']) }}
                                </div>
                            </div>
                            <hr>
