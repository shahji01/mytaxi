...
Route::post('update-driver-face-recognization',[Api\UserController::class,'updateDriverFaceRecognization']);
Route::post('face-detection',[API\UserController::class,'faceDetection']);
...
Route::post('update-user-detail',[API\UserController::class, 'UpdateUserDetail']);

Route::get('document-list', [ API\DocumentController::class, 'getList' ] );
Route::get('group-document-list', [ API\DocumentController::class, 'getDoucumentList' ] );
