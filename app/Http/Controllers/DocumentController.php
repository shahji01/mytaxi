...
class DocumentController extends Controller
{
    ...
    public function create()
    {
        ...
        $fields = Field::all();
        $groups =Group::all();
        return view('document.form', compact('pageTitle','fields','groups'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = Document::with('field')->findOrFail($id);
        $fields = Field::all(); // Fields fetch karna
        $groups =Group::all();
        return view('document.form', compact('data', 'pageTitle', 'id', 'fields','groups'));
    }
